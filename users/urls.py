...
urlpatterns = [
    ...
    path('book/', user_views.package_list, name='book'),
    
    # This path is for your new create_booking_view
    # This fixes the {% url 'create_booking' %} error
    path('create-booking/', user_views.create_booking_view, name='create_booking'),
    ...
    path('agent-dashboard/', user_views.agent_dashboard, name='agent_dashboard'),
    path('home/', user_views.req_home, name='req_home'),
]